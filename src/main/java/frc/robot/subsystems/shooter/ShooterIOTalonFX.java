...
public class ShooterIOTalonFX implements ShooterIO {
  ...
  private final MotionMagicVoltage hoodMotionMagicReq = new MotionMagicVoltage(0.0);
  ...
  public ShooterIOTalonFX() {
    ...
    flywheelCfg.Voltage.PeakReverseVoltage = 0;
    ...
    followerCfg.MotorOutput.Inverted =
        Constants.shooterConstants.FLYWHEEL_FOLLOWER_INVERTED
            ? InvertedValue.Clockwise_Positive
            : InvertedValue.CounterClockwise_Positive;
  ...
  public void updateInputs(ShooterIOInputs inputs) {
    ...
    inputs.flywheelLeaderVelocityRadPerSec =
        Units.rotationsToRadians(leaderVelocity.getValueAsDouble());
    inputs.flywheelFollowerVelocityRadPerSec =
